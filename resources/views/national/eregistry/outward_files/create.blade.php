...
<div class="container mx-auto px-4 py-6 max-w-7xl">
    ...
    <input type="file" name="file" id="file" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
        ...
        <div>
            ...
            <input type="date" name="send_date" id="send_date" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
        </div>

        <!-- Letter Date -->
        <div>
            <label for="letter_date" class="block text-sm font-medium text-gray-700">Letter Date</label>
            <input type="date" name="letter_date" id="letter_date" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
        </div>

        <!-- Letter Ref No -->
        <div>
            <label for="letter_ref_no" class="block text-sm font-medium text-gray-700">Letter Reference Number</label>
            <input type="text" name="letter_ref_no" id="letter_ref_no" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
        </div>

        <!-- Details -->
        <div>
            <label for="details" class="block text-sm font-medium text-gray-700">Details</label>
            <textarea name="details" id="details" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" rows="4" required></textarea>
        </div>

        <!-- From Details -->
        <div>
            <label for="from_details_name" class="block text-sm font-medium text-gray-700">From Details</label>
            <input type="text" name="from_details_name" id="from_details_name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
        </div>

        <!-- To Details -->
        <div>
            <label for="to_details_name" class="block text-sm font-medium text-gray-700">To Details</label>
            <input type="text" name="to_details_name" id="to_details_name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
        </div>
