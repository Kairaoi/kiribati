    ...
    <div class="bg-white rounded-lg shadow-md p-6 mt-6 mb-6">
        <dl class="grid text-base">
            <div class="col-span-2 sm:grid sm:grid-cols-3 sm:gap-4 py-2 border-b">
                <dt class="font-bold text-cyan-700">File Type Details</dt>
            </div>
            
            <div class="col-span-2 sm:grid sm:grid-cols-3 sm:gap-4 py-2 border-b">
                <dt class="font-semibold text-sm text-gray-700">Name:</dt>
                <dd class="sm:col-span-2 text-sm text-gray-900">{{ $fileType->name }}</dd>
            </div>

            <div class="col-span-2 sm:grid sm:grid-cols-3 sm:gap-4 py-2 border-b">
                <dt class="font-semibold text-sm text-gray-700">Description:</dt>
                <dd class="sm:col-span-2 text-sm text-gray-900">{{ $fileType->description }}</dd>
            </div>
            ...
            <div class="col-span-2 sm:grid sm:grid-cols-3 sm:gap-4 py-2 border-b">
                <dt class="font-semibold text-sm text-gray-700">Scope:</dt>
                <dd class="sm:col-span-2">
                    @if($fileType->ministry_id)
            ...
            <div class="col-span-2 sm:grid sm:grid-cols-3 sm:gap-4 py-2 border-b">
                ...
                <dd class="sm:col-span-2 text-sm text-gray-900">
                    {{ $fileType->created_at->format('d M Y') }}
            ...
            <div class="col-span-2 sm:grid sm:grid-cols-3 sm:gap-4 py-2 border-b">
                ...
                <dd class="sm:col-span-2 text-sm text-gray-900">
                    {{ $fileType->updated_at->format('d M Y') }}
