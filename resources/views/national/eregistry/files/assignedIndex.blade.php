...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8 max-w-full rounded-md min-h-screen">
        <div class="mb-4 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800">Your assigned files</h1>
            </div>
...
{{-- 
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-2">        
            <table id="assignedFilesTable" class="bg-gray-50 text-gray-600 text-sm divide-y divide-gray-200 stripe">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Reference No</th>
...
@push('styles')
    <style>
        ...
        /* Header */
        #assignedFilesTable thead {
            background-color: #e9edee;
            color: #5c5d5f;
            font-size: 12px;
        }

        #assignedFilesTable thead th {
            padding: 8px 10px;
            font-weight: 600;
        ...
        /* Hover effect */
        #assignedFilesTable tbody tr:hover {
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                let table = $('#assignedFilesTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ route('registry.files.assigned.datatables') }}",  // Updated route
                        type: 'POST',
                        headers: {
                        ...
                        { 
                            ...
                            render: function(data, type, row) {
                                ...
                                if (data === 'Pending Action') {
                                    ...
                                    badgeClass = 'bg-gray-400 text-xs text-slate-700 px-2 py-1 rounded-full font-semibold';
                                }
