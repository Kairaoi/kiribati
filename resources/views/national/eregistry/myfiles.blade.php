...
<div class="container">
    ...
    @role(['registry','admin'])
        ...
        <div class="tabs" id="tabs">
            @foreach ([ 
                ['id' => 'files-to-review', 'title' => 'Files For Assignment', 'icon' => '', 'route' => 'registry.file-circulations.review.index'],
        ...
        <!-- Tab Content -->
        @foreach ([ 
            ['id' => 'files-to-review', 'title' => 'Files To Review', 'btn-title' => 'Manage Assignments', 'description' => 'Review and assign these files to the appropriate officers.', 'route' => 'registry.file-circulations.review.index'],
    ...
    @role(['user'])
        ...
        <div class="tabs" id="tabs">
            @foreach ([ 
                ['id' => 'my-dispatches', 'title' => 'My Dispatches', 'icon' => 'bi bi-house-earmark', 'route' => 'registry.dispatches.user.index'],
                ['id' => 'assigned-files', 'title' => 'My Assigned Files', 'icon' => 'bi bi-house-earmark', 'route' => 'registry.files.index'],
                ['id' => 'files-to-review', 'title' => 'Files For Assignment', 'icon' => '', 'route' => 'registry.file-circulations.review.index'],
        ...
        <!-- Tab Content -->
        @foreach ([ 
            ['id' => 'my-dispatches', 'title' => 'My Dispatches', 'btn-title' => 'Manage my dispatches', 'description' => 'Manage files you created for dispatch', 'route' =>'registry.dispatches.user.index'],
            ['id' => 'assigned-files', 'title' => 'My Assigned Files', 'btn-title' => 'View My Files', 'description' => 'Files assigned to you for action', 'route' => 'registry.files.index'],
            ['id' => 'files-to-review', 'title' => 'Files To Review', 'btn-title' => 'Manage Assignments', 'description' => 'Review and assign these files to the appropriate officers.', 'route' => 'registry.file-circulations.review.index'],
        ] as $tab)
            <div class="tab-content {{ $loop->first ? 'active' : '' }}" id="{{ $tab['id'] }}">
