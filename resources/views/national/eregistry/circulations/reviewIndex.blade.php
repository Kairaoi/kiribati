...
<div class="container mx-auto font-poppins px-4 py-8 max-w-5xl mt-3 rounded-md min-h-screen ">
    <div class="mb-4 flex items-start justify-between">
        <div>
            <h1 class="text-3xl font-bold tracking-wide">Files to Review</h1>
            <p class="text-base text-gray-500 mt-1">
                Review internal files from your ministry and all other incoming files from other ministries.
            </p>
        </div>
...
$(document).ready(function() {
    ...
    $('#reviewsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('registry.file-circulations.reviews.datatables') }}",  // Updated route
            type: 'POST',
            headers: {
