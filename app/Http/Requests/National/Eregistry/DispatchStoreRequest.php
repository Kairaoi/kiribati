    ...
    public function rules(): array
    {
        return [
            ...
            'from_organisation_id' => [
                'required',
                'exists:organisations,id', // Validates that the from_organisation_id exists in the organisations table
            ],
            // 'to_organisation_id' => [
            //     'required',
            //     'exists:organisations,id', // Validates that the to_organisation_id exists in the organisations table
            // ],
            'from_division_id' => [
                'required',
